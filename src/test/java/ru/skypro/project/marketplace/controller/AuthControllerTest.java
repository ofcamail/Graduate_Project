...
public class AuthControllerTest {
    ...
    void setUp() {
        ...
        loginReq.setUsername("test@mail.ru");
        loginReq.setPassword("testtest");

        registerReq.setUsername("test2@mail.ru");
        registerReq.setFirstName("Test2");
        registerReq.setLastName("Test2");
        registerReq.setPhone("+79999999989");
        registerReq.setPassword("testtest2");
